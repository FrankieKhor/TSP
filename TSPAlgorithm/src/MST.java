...
public class MST
{
	 static ArrayList<Double>weigthValue = new ArrayList<Double>();
	...
	public static double[][] PrimsMST(double[][] d)
	{
		...
		while(v.size() != n)
		{
			...
			MST.weigthValue.add(e.w);
					
			}	
		return(res);
	}
	public static double weightValues (){
		double totalWeight = 0;	
		//System.out.println("weightvalues"+weigthValue);
		for(int o=0;o<weigthValue.size();o++){
			totalWeight +=weigthValue.get(o);
			}
		return totalWeight;
